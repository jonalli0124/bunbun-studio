...
// Both variants exist unconditionally so classic mode can be selected at
// RUNTIME (per network) as well as at compile time via CONFIG_AIRPLAY_FORCE_V1.
// V1: strip pairing/encryption bits so iOS uses classic RAOP.
#define AIRPLAY_FEATURES_V1_HI 0x0
#define AIRPLAY_FEATURES_V1_LO 0x5C4A00
#define AIRPLAY_FEATURES_V2_HI 0x1C340
#define AIRPLAY_FEATURES_V2_LO 0x405C4A00
#ifdef CONFIG_AIRPLAY_FORCE_V1
#define AIRPLAY_FEATURES_HI AIRPLAY_FEATURES_V1_HI
#define AIRPLAY_FEATURES_LO AIRPLAY_FEATURES_V1_LO
#else
#define AIRPLAY_FEATURES_HI AIRPLAY_FEATURES_V2_HI
#define AIRPLAY_FEATURES_LO AIRPLAY_FEATURES_V2_LO
#endif
